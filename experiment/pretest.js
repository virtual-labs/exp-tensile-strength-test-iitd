...
(function() {
    ...
    const myQuestions = [{
            question: "1.Which Indian Standard (IS) code is adopted for the determination of split tensile strength of hardened concrete?", ///// Write the question inside double quotes
            answers: {
